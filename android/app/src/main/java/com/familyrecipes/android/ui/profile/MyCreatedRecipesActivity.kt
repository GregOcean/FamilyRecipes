...
import com.familyrecipes.android.databinding.ActivityMyCreatedRecipesBinding
 ...
 * 我上传的菜谱页面
 */
class MyCreatedRecipesActivity : AppCompatActivity() {

    private lateinit var binding: ActivityMyCreatedRecipesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMyCreatedRecipesBinding.inflate(layoutInflater)
    ...
    private fun setupRecyclerView() {
        ...
        binding.recyclerView.apply {
            layoutManager = LinearLayoutManager(this@MyCreatedRecipesActivity)
    ...
    private fun loadMyRecipes() {
        ...
        lifecycleScope.launch {
            try {
                val response = ApiClient.getService().getMyCreatedRecipes()
